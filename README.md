<h1> Проект на тему: сайт по продаже комплектующих для компьютера. <br>
...
## Цель (цель как задачи что поставленны перед проектом и решаются постепенно) 
...
Ссылка: http://a1066186.xsph.ru/ Сайт доступен(НАВЕРНОЕ)
