<h1> Проект на тему: сайт по продаже комплектующих для компьютера. </h1>
...
## Цель (цель как задачи что поставленны перед проектом что решаются постепенно) (развернутая цель проекта https://github.com/Okylistik/Project/edit/main/README.md)
